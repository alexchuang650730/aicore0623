"""
簡化Agent架構配置
Simplified Agent Architecture Configuration
"""

import os
from typing import Dict, List, Any

class SimplifiedAgentConfig:
    """簡化Agent配置類"""
    
    # 基本配置
    AGENT_NAME = "simplified_agent"
    AGENT_VERSION = "1.0.0"
    AGENT_DESCRIPTION = "基於Kimi-Researcher理念的簡化Agent架構"
...
class TestingConfig(SimplifiedAgentConfig):
    ...
    LOGGING = {
        **SimplifiedAgentConfig.LOGGING,
        'level': 'DEBUG',
        'file': 'test_simplified_agent.log'
    }
